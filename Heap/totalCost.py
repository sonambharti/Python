...
worker but they have the smallest index [3,2,7,7,2]. Please note that the indexing may be changed in 
the process.
...
- In the second hiring round we choose the worker from [2,4,1]. The lowest cost is 1 (index 2). The total 
cost = 1 + 1 = 2.
...
def totalCost(costs, k, candidates):
    ...
    while(k > 0):
        ...
        # minm from left
        a = pq1[0] if pq1 else sys.maxsize
        # minm from right
        b = pq2[0] if pq2 else sys.maxsize
...
if __name__ == "__main__":
    ...
    print("Total Cost to Hire K Workers: ", res)
